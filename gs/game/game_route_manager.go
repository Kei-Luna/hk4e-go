...
func (r *RouteManager) initRoute() {
	...
	r.registerRouter(cmd.EvtBulletDeactiveNotify, GAME.EvtBulletDeactiveNotify)
	r.registerRouter(cmd.EvtBulletHitNotify, GAME.EvtBulletHitNotify)
	r.registerRouter(cmd.EvtBulletMoveNotify, GAME.EvtBulletMoveNotify)
